...
const imagemBotaoTracoDeTema = document.querySelector(".imagem-botao")
...
botaoAlterarTema.addEventListener("click", () => {
    ...
    if (modoEscuroEstaAtivo) {
        ...
        //- passo 8 - trocar a imagem do botão de alterar tema pra sol
        imagemBotaoTracoDeTema.setAttribute("src", "./src/imagens/sun.png");
        ...
        //- passo 5 - trocar a imagem do botão de alterar tema pra lua
        imagemBotaoTracoDeTema.setAttribute("src", "./src/imagens/moon.png");
    }
